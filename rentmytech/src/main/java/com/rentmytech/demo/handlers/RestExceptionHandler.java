...
import com.rentmytech.demo.exceptions.ResourceFoundException;
import com.rentmytech.demo.exceptions.ResourceNotFoundException;
import com.rentmytech.demo.models.ErrorDetail;
import com.rentmytech.demo.services.ValidationHelper;
        ...
        extends ResponseEntityExceptionHandler
{
    ...
    public ResponseEntity<?> handleResourceNotFoundException(ResourceNotFoundException rnfe)
    {
        ...
        errorDetail.setDeveloperMessage(rnfe.getClass()
                .getName());
        errorDetail.setErrors(validationHelper.getConstraintViolation(rnfe));
    ...
    public ResponseEntity<?> handleResourceFoundException(ResourceFoundException rfe)
    {
        ...
        errorDetail.setDeveloperMessage(rfe.getClass()
                .getName());
        errorDetail.setErrors(validationHelper.getConstraintViolation(rfe));
            ...
            WebRequest request)
    {
        ...
        errorDetail.setDeveloperMessage(ex.getClass()
                .getName());
        errorDetail.setErrors(validationHelper.getConstraintViolation(ex));
